...
public class CustomerEavAttributeSelectTemplateFile implements ModuleFileInterface {

    public static final String TEMPLATE = "Magento Customer Eav Attribute Select Templates PHTML";
    public static final String DIRECTORY = "view/frontend/templates";
    public static final String FILE_EXTENSION = "phtml";

    private final String fileName;

    public CustomerEavAttributeSelectTemplateFile(
